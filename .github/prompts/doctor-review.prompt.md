...
- Validate that all page routes and navigation links point to real files in `hasan-portfolio/app/`.
...
- `cd hasan-portfolio && npm run lint`
- `cd hasan-portfolio && npm run build`
